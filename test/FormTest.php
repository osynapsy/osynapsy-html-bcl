...
final class FormTest extends TestCase
{
    ...
    {        
        ...
        $this->assertEquals(
            '<form id="test" name="test" method="post" role="form"><div id="testPanel" class="m-2 p-2 panel"><div class="panel-body"><div class="row mb-4"><div class="col-lg-12 col-md-12 col-sm-12 col"><div class="form-group"><div class="d-flex"><label class="form-group me-auto mr-auto">test label</label></div>test content</div></div></div></div></div></form>',
            $this->tabAndEolRemove((string) $Form)
        );
    }
