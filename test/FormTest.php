...
final class FormTest extends TestCase
{
    ...
    public function testForm(): void
    {
        $Form = new Form('test');
        $this->assertEquals(
            '<form id="test" name="test" method="post" role="form"><div id="testPanel" class="panel"><div class="panel-heading clearfix"><div class="panel-title pull-left"></div><div class="panel-commands pull-right"></div></div><div class="panel-body"></div></div></form>',
    ...
    {        
        ...
        $this->assertEquals(
            '<form id="test" name="test" method="post" role="form"><div id="testPanel" class="panel"><div class="panel-heading clearfix"><div class="panel-title pull-left"></div><div class="panel-commands pull-right"></div></div><div class="panel-body"><div class="row"><div class="col-lg-12 col-md-12 col-sm-12 col"><div class="form-group"><div class="d-flex"><label class="form-group mr-auto">test label</label></div>test content</div></div></div></div></div></form>',
            $this->tabAndEolRemove((string) $Form)
        );
    }
